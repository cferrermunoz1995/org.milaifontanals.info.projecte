...
insert into USUARI (email_usuari, login_usuari, contrasenya_usuari) values ('cferrer1@milaifontanals.org', 'cferrer1', 'f2b3df767a58b4cb680e6e1d88fdb031e40de6ee83cc286d6c58f8e6d434294a');
insert into USUARI (email_usuari, login_usuari, contrasenya_usuari) values ('cferrer2@milaifontanals.org', 'cferrer2', 'e6fd7c1e20330533f32924314dc90e44b4cfc4c3d5d98c613af58c833446f689');
insert into USUARI (email_usuari, login_usuari, contrasenya_usuari) values ('cferrer3@milaifontanals.org', 'cferrer3', 'c101700a968933284c8475e6d8c48967eec0dd2d53f3e8585b213f6719f0068c');
insert into USUARI (email_usuari, login_usuari, contrasenya_usuari) values ('cferrer4@milaifontanals.org', 'cferrer4', '373bcddd6bf8905f45bf07a4b3270a47ca9a0658b996f94ab71f3172c208ef47');
...
insert into Ruta (id_ruta, titol_ruta, descrip_ruta, text_long_ruta, distancia_ruta, temps_ruta, desn_pos_ruta, desn_neg_ruta, dificultat_ruta, id_usuari_ruta)
values (null, 'Ruta 4', 'Descripció ruta 4', 'Ruta 4 - València', 10, 2, 100, 100, 1, 'cferrer1');

insert into PUNT (id_punt, num_punt, id_ruta_punt, nom_punt, desc_punt, foto_punt, lat_punt, lon_punt, tipus_punt, alt_punt) values
(null, 1, 1, 'Punt 1 - Ruta 1', 'Punt 1 - Ruta 1', null, 12.1, 13.1, 1, 3.1);
...
insert into PUNT (num_punt, id_ruta_punt, nom_punt, desc_punt, foto_punt, lat_punt, lon_punt, tipus_punt) values
(1, 4, 'Punt 1 - Ruta 4', 'Punt 1 - Ruta 4', null, 12, 13, 1);
insert into PUNT (num_punt, id_ruta_punt, nom_punt, desc_punt, foto_punt, lat_punt, lon_punt, tipus_punt) values
(2, 4, 'Punt 2 - Ruta 4', 'Punt 2 - Ruta 4', null, 12, 13, 2);
