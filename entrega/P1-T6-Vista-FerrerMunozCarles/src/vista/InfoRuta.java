...
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByAlt;
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByDesc;
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByLatitud;
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByLong;
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByName;
import P1_T5_Model_FerrerMunozCarles.Punt.PuntSortByNum;
...
public class InfoRuta extends JFrame {
    ...
    private void initComponents() {
        ...
        txtDistancia.setToolTipText("Valors positius i numèrics, en kilòmetres");

        jLabel5.setText("Temps:");

        txtTemps.setToolTipText("Valors positius i numèrics, en hores");

        jLabel6.setText("Desnivell Positiu:");

        txtDesnPos.setToolTipText("Valors positius i numèrics, en metres");

        jLabel7.setText("Desnviell negatiu:");

        txtDesnNeg.setToolTipText("Valors positius i numèrics, en metres");
        ...
        jTable1.setToolTipText("Doble clic per veure informació del punt. Si cliquem sobre el nom de les columnes podrem ordenar els punts.");
        ...
        btnAfegir.setToolTipText("Abans d'inserir cap punt la ruta ha d'estar guardada");
