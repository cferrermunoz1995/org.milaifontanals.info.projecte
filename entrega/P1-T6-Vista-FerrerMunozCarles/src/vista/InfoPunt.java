...
public class InfoPunt extends JFrame {
    ...
    private void initComponents() {
        ...
        txtNum.setToolTipText("Només hi pot haver un punt amb el mateix número per ruta");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        txtLatitud.setToolTipText("Valors entre -90 i 90");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.gridwidth = 2;
        ...
        txtLongitud.setToolTipText("Valors entre -180 i 180");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 10;
        gridBagConstraints.gridwidth = 2;
        ...
        txtAltitut.setToolTipText("No obligatori");
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        int res = JOptionPane.showConfirmDialog(this, "Estàs segur que vols guardar el Punt?", "Guardar punt", ConfirmationCallback.YES_NO_OPTION);
        if (res == JOptionPane.YES_OPTION){
            if (mPunt == null){
                ...
                try {
                    if (gBD.afegirPunt(mPunt)){
                        JOptionPane.showMessageDialog(rootPane, "Punt inserit", "Èxit",JOptionPane.PLAIN_MESSAGE);
                        gBD.validateChanges();
                        InfoRuta ir = new InfoRuta(gBD, mRuta, optionRuta, mUser);
                        ir.setVisible(true);
                        this.dispose();
                ...
                try {
                    ...
                    if(gBD.actualitzarPunt(mPunt)){
                        JOptionPane.showMessageDialog(rootPane, "Punt actualitzat", "Èxit",JOptionPane.PLAIN_MESSAGE);
                ...
                } catch (WikilocException | IGestorBDWikilocException ex){
